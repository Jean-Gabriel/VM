...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref master
  WORKING_DIRECTORY "C:/Users/Client/Documents/Projects/VirtualMachine/build/googletest-src"
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" rev-list --max-count=1 master
  WORKING_DIRECTORY "C:/Users/Client/Documents/Projects/VirtualMachine/build/googletest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Client/Documents/Projects/VirtualMachine/build/googletest-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Client/Documents/Projects/VirtualMachine/build/googletest-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
